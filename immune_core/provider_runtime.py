...
from .providers import OpenAICompatibleHTTPProvider, ProviderManager
...
class ProviderRuntimeConfig:
    ...
    def load(cls, path: str | Path) -> "ProviderRuntimeConfig":
        ...
        if owner_scope != "immune-core":
            raise ProviderConfigurationError("provider owner_scope must be immune-core")
    ...
    def build_manager(
        ...
        return ProviderManager(providers, identity, audit, owner_scope=self.owner_scope)
